...
Вы можете создать образ восстановления Microsoft Diagnostics и Recovery (DaRT) с помощью сценария PowerShell, а не с помощью мастера создания изображений для восстановления DaRT 10. Посмотрите следующий пример сценария.
