...
---
# Использование сценария PowerShell для создания образа для восстановления


## <a href="" id="bkmk-create-image-use-script"></a>Создание изображения для восстановления DaRT с помощью сценария PowerShell


Вы можете создать образ восстановления для компонента Microsoft Diagnostics и Recovery (DaRT) 8,0 с помощью сценария PowerShell, а не с помощью мастера DaRT 8,0 для восстановления изображений. Посмотрите следующий пример сценария.
...
`Import-Module "Dism"`Думаю`mport-Module "Microsoft.Dart"`
