...
ms.locfileid: "10822889"
---
# <span data-ttu-id="08a41-103">Использование сценария PowerShell для создания образа для восстановления</span><span class="sxs-lookup"><span data-stu-id="08a41-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="08a41-104">Создание изображения для восстановления DaRT с помощью сценария PowerShell</span><span class="sxs-lookup"><span data-stu-id="08a41-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="08a41-105">Вы можете создать образ восстановления для компонента Microsoft Diagnostics и Recovery (DaRT) 8,0 с помощью сценария PowerShell, а не с помощью мастера DaRT 8,0 для восстановления изображений.</span><span class="sxs-lookup"><span data-stu-id="08a41-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="08a41-106">Посмотрите следующий пример сценария.</span><span class="sxs-lookup"><span data-stu-id="08a41-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="08a41-107">Думаю</span><span class="sxs-lookup"><span data-stu-id="08a41-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="08a41-108">Статьи по теме</span><span class="sxs-lookup"><span data-stu-id="08a41-108">Related topics</span></span>


[<span data-ttu-id="08a41-109">Администрирование DaRT 8.0 с помощью PowerShell</span><span class="sxs-lookup"><span data-stu-id="08a41-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
