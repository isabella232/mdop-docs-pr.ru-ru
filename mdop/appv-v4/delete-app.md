...
Удаляет запись приложения из кэша файловой системы, чтобы сделать ее более невидимой. Ярлыки пользователей и сопоставления типов файлов скрыты, но не удаляются. Пользовательские параметры не удаляются.
...
<td align="left"><p>Имя и версия (необязательно) приложения, которое нужно удалить.</p></td>
</tr>
<tr class="even">
