...
Чтобы использовать консоль управления App-V для настройки этой конфигурации, ознакомьтесь со [сведениями о том, как опубликовать пакет с помощью консоли управления](how-to-publish-a-package-by-using-the-management-console-50.md).
