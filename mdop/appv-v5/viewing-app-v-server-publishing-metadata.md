...
-   [Требования к App-V 5,0 SP3 для просмотра метаданных публикации](#bkmk-50sp3-reqs-pub-meta)
...
## <a href="" id="bkmk-50sp3-reqs-pub-meta"></a>Требования к App-V 5,0 SP3 для просмотра метаданных публикации
...
<div class="alert">
<strong>Примечание.</strong><br/><p><strong>ClientVersion </strong> и <strong> ClientOS </strong> поддерживаются только в App-V 5,0 SP3.</p>
</div>
<div>

</div></td>
<td align="left"><p>Ознакомьтесь со сведениями о приложении App-V 5,0 SP3.</p></td>
