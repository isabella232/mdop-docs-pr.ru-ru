...
<td align="left"><p>При применении файла группы подключения Application Virtualization 5,0 пакеты, перечисленные в файле, будут объединяться во время выполнения в одну виртуальную среду. С помощью файла группы подключения Microsoft Application Virtualization (App-V) 5,0 можно настроить существующие группы соединений для Application Virtualization 5,0.</p></td>
</tr>
<tr class="odd">
...
-   [Пример XML-файла для группы подключения приложения (SP3) 5,0](#bkmk-50sp3-exp-cg-xml)
...
<p>Узнайте <a href="how-to-use-optional-packages-in-connection-groups.md" data-raw-source="[How to Use Optional Packages in Connection Groups](how-to-use-optional-packages-in-connection-groups.md)"> , как использовать дополнительные пакеты в группах соединений </a> .</p></td>
</tr>
</tbody>
</table>
...
### <a href="" id="bkmk-50sp3-exp-cg-xml"></a>Пример XML-файла для группы подключения приложения (SP3) 5,0

Ниже приведен пример XML-файла группы подключения, в котором показаны примеры полей в предыдущих таблицах, а также выделены новые элементы для App-V 5,0 SP3.
...
-   Укажите приоритеты выполнения для групп подключения.
