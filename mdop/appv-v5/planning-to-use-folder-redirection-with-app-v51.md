...
Microsoft Application Virtualization (App-V) 5,1 поддерживает использование функции перенаправления папок, позволяющей пользователям и администраторам перенаправлять путь к папке в новое расположение.
...
<tr class="even">
<td align="left"><p>В App-V 5,0 SP3 и более поздних версиях</p></td>
...
<p>Для обеспечения избыточности приложение App-V хранит три последние копии сжатых данных в разделе% AppData%.</p></td>
</tr>
</tbody>
</table>
